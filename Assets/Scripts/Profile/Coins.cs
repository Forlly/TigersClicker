...
namespace Project
{
    [Serializable, HideLabel, Title("Coins")]
    public class Coins
    {
        public int Count
        {
        ...
        private const string SAVE_ID = "Profile-Coins";
        ...
        public async void Save()
        {
            ...
            CoinsSaveData data = new CoinsSaveData
            {
                Count = Count
            };
        ...
        public async Task Load()
        {
            ...
            if (!_saveSystem.HasSave(SAVE_ID))
                return;
            CoinsSaveData data = await _saveSystem.Load<CoinsSaveData>(SAVE_ID);
        ...
        {
            EventBus.Instance.Send(new CoinsChangedEvent(this));
